          ...
          sidebar: [
            ...
            },
            {
              ...
              items: [
                ...
                { text: "Discord 存储配置", link: "/guide/discord-storage-config" },
                { text: "HuggingFace 存储配置", link: "/guide/huggingface-storage-config" },
                { text: "Mirror 存储配置", link: "/guide/mirror-storage-config" },
          ...
          sidebar: [
            ...
            },
            {
              ...
              items: [
                ...
                { text: "Discord Storage Configuration", link: "/en/guide/discord-storage-config" },
                { text: "HuggingFace Storage Configuration", link: "/en/guide/huggingface-storage-config" },
                { text: "Mirror Storage Configuration", link: "/en/guide/mirror-storage-config" },
